    ...
    public class EducationsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Education != null ? 
                          ...
                          Problem("Entity set 'CrudContext.Education'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("education_id,name,degree_name,board_name,college_name,start_date,end_date,information_ID")] Education education)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("education_id,name,degree_name,board_name,college_name,start_date,end_date,information_ID")] Education education)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!EducationExists(education.education_id))
                    {
                        return NotFound();
                    }
                    else
