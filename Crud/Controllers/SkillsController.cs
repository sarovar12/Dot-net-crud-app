    ...
    public class SkillsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Skills != null ? 
                          ...
                          Problem("Entity set 'CrudContext.Skills'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("skill_id,skill_name,information_id")] Skills skills)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("skill_id,skill_name,information_id")] Skills skills)
        {
